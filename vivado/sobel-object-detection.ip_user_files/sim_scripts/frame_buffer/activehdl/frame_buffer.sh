...
#
# Script generated by Vivado on Tue May 05 13:11:38 -0500 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Projects/VivadoProjects/sobel-object-detection/vivado/sobel-object-detection.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
