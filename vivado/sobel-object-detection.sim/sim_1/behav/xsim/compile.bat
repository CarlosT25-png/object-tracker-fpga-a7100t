...
REM
REM Generated by Vivado on Mon May 11 21:35:45 -0500 2026
...
echo "xvlog --incr --relax -prj tb_servo_pwm_vlog.prj"
call xvlog  --incr --relax -prj tb_servo_pwm_vlog.prj -log xvlog.log
